  ...
  )
{
  ...
  Status = CreateBasicVariablePolicy (&mTestGuid1,
                                      TEST_VAR_1_NAME,
    ...
    )
{
  ...
  //
  Status = CreateUnitTestSuite( &ShimTests, Framework, "Variable Lock Shim Tests", "VarPolicy.VarLockShim", NULL, NULL );
  if (EFI_ERROR( Status ))
  {
